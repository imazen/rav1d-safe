...
/// THROWAWAY site-selective tracker nulling (feature `__probe_class`). UNSOUND;
/// measurement only. Not public API.
#[cfg(any(feature = "__probe_class", feature = "__probe_sites"))]
pub mod site_class;
