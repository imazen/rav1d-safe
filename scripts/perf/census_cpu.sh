#!/usr/bin/env bash
# CPU-time twin of gap_sweep.sh. Same two-point fit, but on user+sys instead of
...
c256x2048:8:20:200 c1024x384:8:20:200 c1024x192:8:20:200 c3840x256:8:12:120 \
c1024x576:8:20:200 v4k8tile:8:4:40 v4k8tile:1:4:40}"
