...
for name,feature in [('restored','asm'),('current','tracker-off'),('current','asm-tracker-off')]:
 ...
 records.append(record);(root/'diagnostic-builds.json').write_text(json.dumps(records,indent=2)+'\n')
