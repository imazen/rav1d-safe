...
for name,feature in [('current',''),('current','unchecked'),('current','asm'),('first',''),('first','unchecked'),('first','asm')]:
 ...
 records.append(record);(root/'builds.json').write_text(json.dumps(records,indent=2)+'\n')
